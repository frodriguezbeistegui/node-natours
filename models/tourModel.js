...
// const User = require('./userModel');  It was necesary for embedding
...
const tourSchema = new mongoose.Schema(
  {
    ...
    ratingsAverage: {
      ...
      set: val => val.Math.round(val * 10) / 10,
    },
    ratingsQuantity: {
      type: Number,
      default: 0,
    ...
    imageCover: {
      type: String,
      require: [true, 'A tour musthave a cover image'],
    },
    images: [String],
    createdAt: {
      type: Date,
...
// Embedding user into Tour model
